...
CODEY = re.compile(r'(console\.|document\.|\.textContent|\.innerHTML|alert\(|prompt\(|\breturn\s+["\'\u2018\u201c]|=\s*["\'\u2018\u201c]|\.push\(|\.log\(|\bnew\s+\w+\(\s*["\'\u2018\u201c])')
ANY    = re.compile(r'(console\.|function\s|=>|\breturn\b|document\.|alert\(|\.log\(|=\s*[\[\{\'"]|\bnew\s+\w+\(\s*["\'\u2018\u201c])')
